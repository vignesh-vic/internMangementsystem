...
export default function PassedOut(props) {
  ...
  //JSON values
  useEffect(() => {
    setPassedOutDetails(Internjson.Interns);
  },[setPassedOutDetails]);
  //defauldcoldefs
  const defaultCol = {
    sortable: true,
  ...
  return (
    <>
      <div className="  float-left	 ">
        <div className="  p-4 ">
          <div className="pb-5">
            <button className="border-2 text-white border-gray-600 p-1 h-10 rounded-md bg-red-600"
             onClick={() => {
                showModal();
                setInputDetails({
                  Id: "",
